...
<b>Point of Sale (POS) and Inventory Management System (IMS)</b> is a .NET 8.0 Core MVC and console application..NET Core is chosen due to its open source nature and is maintained by Microsoft. </b> <br />
